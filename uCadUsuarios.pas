...
procedure TfCadUsuarios.AtualizarClick(Sender: TObject);
begin
...
procedure TfCadUsuarios.DeletarClick(Sender: TObject);
...
procedure TfCadUsuarios.EditarClick(Sender: TObject);
begin
